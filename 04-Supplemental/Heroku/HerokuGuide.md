...
4. Rename the app to whatever you want using the command `heroku apps:rename my_new_app_name`.

5. Run `git remote –v` again.
...
6. Ensure that your `package.json` file is set up correctly. It must have a `start` script and all the project's dependencies defined. E.g.:
...
7. Ensure your web server is starting with a dynamic port.
...
8. Ensure that you have at least one HTML page being served at the "/" route. Example:
